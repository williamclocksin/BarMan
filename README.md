...
In the "no assumption" model, bars of music may be unmeasured, contain different numbers of beats, different lengths, and polymetres. Systems may contain any number of staves, and BarMan's formatting algorithms format a system at a time. The algorithm has been used in Calliope, so is tried and tested.
